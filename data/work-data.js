const arrWork = [
  ...
  // },
  {
    ...
    he: {
      title: 'to do list ',
      description: 'כולל הוספת משימות, עדכון משימות מחיקת משימה ועוד',
      note: 'עיצוב אלגנטי עם tailwind',
    },
    en: {
      title: 'to do list ',
      description: 'to do list with add delete and update a task',
      note: 'fully responsive with tailwind',
    },
    tec: ['html', 'react', 'tailwind',],
    sort_path: ['frontend'],
    web_link: 'https://to-do-list-tailwind.netlify.app/',
    git_link: 'https://github.com/yosefus/to-do-list-tailwind',
